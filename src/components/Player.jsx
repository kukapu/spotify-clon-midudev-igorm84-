...
const SongControl = ({ audio }) => {
  ...
  return (
    <div className="flex gap-x-3 text-xs mt-2">
      <span className="opacity-50 w-6 text-right">{formatTime(currentTime)}</span>
      < Slider
        value={[currentTime]}
        max={duration}
        min={0}
...
const VolumeControl = () => {
  ...
  return (
    <div className="flex justify-center gap-x-2">
      <button className="opacity-70 hover:opacity-100 transition" onClick={handleClickVolumeToggle}>
